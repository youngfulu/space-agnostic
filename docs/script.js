...
const imagePaths = [
    ...
    'Definition of power #mat/IMG_9102.jpg',
    'Definition of power #mat/Screenshot 2022-02-16 at 13.16.32.png',
    'Definition of power #mat/Screenshot 2024-06-04 at 12.34.38.png',
    'Definition of power #mat/photo_2021-01-06_18-39-57.jpg',
    'Definition of power #mat/photo_2021-01-27_13-56-31.jpg',
    'Definition of power #mat/photo_2021-01-27_13-56-34.jpg',
    'Definition of power #mat/photo_2021-04-22_07-07-55.jpg',
    'Definition of power #mat/photo_2022-01-18_15-28-07.jpg',
    'Empreian Tiflis #snd #pf/B-VmOd1HSt3.jpg',
    ...
    'Seen #vis/LTX-2_00005_.gif',
    'Seen #vis/LTX-2_00015_.gif',
    ...
    'Spectral veawings/B/Screenshot 2023-07-11 at 22.19.57_result.jpg',
    'Spectral veawings/B/Screenshot 2023-07-11 at 22.20.09_result.jpg',
    'Spectral veawings/B/Screenshot 2023-07-25 at 23.14.46_result.jpg',
    'Spectral veawings/B/Screenshot 2023-08-12 at 16.34.24.png',
    'Spectral veawings/B/Screenshot 2023-08-12 at 16.34.24_result.jpg',
    'Spectral veawings/B/Screenshot 2023-08-21 at 01.08.40.png',
    'Spectral veawings/B/Screenshot 2023-08-21 at 01.08.40_result.jpg',
    'Spectral veawings/B/Screenshot 2023-09-01 at 21.40.19.png',
    'Spectral veawings/B/Screenshot 2023-09-01 at 21.40.29.png',
    ...
    'Spectral veawings/carpet23.jpg',
    'Spectral veawings/carpet24_result.jpg',
    'Spectral veawings/carpet25_result.jpg',
    'Spectral veawings/carpet27.jpg',
    ...
    'Thresholds/IMG_1098.jpg',
    'Thresholds/IMG_1139.jpg',
    'Thresholds/IMG_2404 copy.jpg',
    'Thresholds/IMG_2404.jpg',
    ...
    'Thresholds/Screenshot 2026-06-27 at 18.08.24.png',
    'Thresholds/TDMovieOut.0.jpg',
    'Thresholds/TDMovieOut.1.jpg',
...
function showMobileProjectPage(folderPath) {
    ...
    Promise.all([
        ...
        // Build DOM — first image at very top (full-bleed, no padding), then header, then rest
        const _base = (window.__BASE_URL__ || '').replace(/\/$/, '');

        // First image (no padding, overlaid by back button)
        if (imgs.length) {
            const heroEncoded = imgs[0].split('/').map(s => encodeURIComponent(s)).join('/');
            const heroImg = document.createElement('img');
            heroImg.className = 'mpg-img mpg-hero';
            heroImg.src = _base + '/img/' + heroEncoded;
            heroImg.alt = '';
            heroImg.loading = 'eager';
            heroImg.fetchPriority = 'high';
            heroImg.decoding = 'async';
            scroll.appendChild(heroImg);
        }

        // Info header (below first image)
        ...
        // Remaining images (skip first, already shown as hero)
        if (imgs.length > 1) {
            const gallery = document.createElement('div');
            gallery.className = 'mpg-gallery';
            imgs.slice(1).forEach((imgPath, i) => {
                const encoded = imgPath.split('/').map(s => encodeURIComponent(s)).join('/');
                const img = document.createElement('img');
